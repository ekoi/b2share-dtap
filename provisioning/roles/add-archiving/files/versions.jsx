...
export const Versions = React.createClass({
    ...
    render() {
        let {isDraft, recordID, versions, communityName} = this.props;
        if (!versions) {
            return false;
        }
            ...
            <div className="row">
                <div className="col-sm-12" >
                    { isDraft ?
                        ...
                        <PublishedVersions recordID={recordID} versions={versions} style={style} communityName={communityName}/> }
                </div>
            </div>
        );
    }
...
const PublishedVersions = React.createClass({
    ...
    render() {
        let {recordID, versions, style, communityName} = this.props;
